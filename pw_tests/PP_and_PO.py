...
from VAST.core.profile_model import ProfileOPModel3, gen_profile_output_list, PPSubmodel
...
post_processor = PPSubmodel(surface_names = surface_names, ode_surface_shapes=ode_surface_shapes, delta_t=delta_t, nt=num_nodes+1, symmetry=False)


model = m3l.DynamicModel()
uvlm = VASTSolverUnsteady(num_nodes=num_nodes, surface_names=surface_names, surface_shapes=surface_shapes, delta_t=delta_t, nt=num_nodes+1, sub=sub, sub_eval_list=sub_eval_list, sub_induced_list=sub_induced_list, free_wake=free_wake)
