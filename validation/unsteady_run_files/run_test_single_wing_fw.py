...
for i in range(len(surface_names)):
    ...
    # profile_outputs.append((f'{surface_names[i]}_wake_total_vel', (112,3)))
    # profile_outputs.append((f'{surface_names[i]}_wake_kinematic_vel', (112,3)))
    # profile_outputs.append((f'{surface_names[i]}_wake_induced_vel', (112,3)))
...
if True:
    ...
    video = Video("uvlm_m3l_single_wing_test.gif", duration=10, backend='ffmpeg')
    for i in range(nt - 1):
        vp = Plotter(
            bg='beige',
            bg2='lb',
