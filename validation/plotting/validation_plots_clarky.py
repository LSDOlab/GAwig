...
h_inf_VAST = {
    'alpha': [-5, -3, -1, 0, 1, 2, 3, 4, 5, 10, 15],
    'CL': [-0.09460199, 0.03716459, 0.16835239, 0.23406397, 0.29969863, 0.36522386, 0.43060729, 0.49581669, 0.56082006, 0.88160348, 1.19268576],
...
ax1.plot(h_inf_VAST['alpha'], h_inf_VAST['CL'], 'r-', linewidth=3)
ax1.plot(clarky_alpha, clarky_CL, 'k-', linewidth=3)
ax1.set_xlabel(r'$\alpha $ $ (^\circ)$', fontsize=20)
# ax1.set_ylabel(r'$C_L$', fontsize=20)
ax1.set_yticks(np.arange(-0.2, 1.41, 0.2))
ax1.tick_params('x', labelsize=15)
ax1.tick_params('y', labelsize=15)
ax1.grid()

ax2.plot(h_inf_VAST['alpha'], h_inf_VAST['CDi'], 'r-', linewidth=3, label=r'VAST')
ax2.plot(clarky_alpha, clarky_CDi, 'k-', linewidth=3, label=r'OpenVSP')
ax2.set_xlabel(r'$\alpha $ $ (^\circ)$', fontsize=20)
# ax2.set_ylabel(r'$C_{Di}$', fontsize=20)
ax2.set_yticks(np.arange(-0.2, 1.41, 0.2))
ax2.tick_params('x', labelsize=15)
ax2.tick_params('y', labelsize=15)
# ax2.grid()
ax2.legend(fontsize=15, loc='upper left')

ax2.annotate(r'$C_L$', (13, 1.15), fontsize=20)
ax2.annotate(r'$C_{Di}$', (13, 0.13), fontsize=20)
